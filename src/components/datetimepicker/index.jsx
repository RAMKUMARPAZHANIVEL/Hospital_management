                    ...
                    <Box sx={{
                        ...
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                            <DateTimePicker
                                ...
                                slotProps={{
                                    textField: {
                                    inputProps: rest.inputProps, // <-- this makes 'data-testid' reach the input
                                    },
                                }}
                                ref={(r) => { this.input = r; }}
                            />
...
const Component = (props) => {
    ...
    const { mode, id, name, value, label, OnInputChange, validators, validationMessages, sx, dataTestId } = props;
    ...
    if (mode === 'view') {
        return (
            <>
                <Typography noWrap component="div" variant="inputView" >
